...
router.post("/:uid/:hid/register", deviceController.create);
...
router.get("/:uid/:hid/:did", deviceController.viewDetail);

router.post("/:uid/:hid/:did/control", deviceController.control);
