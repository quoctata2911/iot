...
router.post("/:uid/members/:hid", homeController.addUser);

router.delete("/:uid/members/:hid", homeController.deleteUser);

router.delete("/:hid/remove-members/:uid", homeController.deleteUser);
...
router.get("/:uid", homeController.view); // Id is userId View
